...
int main()
{
    ...
    float vertices3[] = {
        ...
        // Rectangulo Amarillo
        //El derecho
       -0.1f, 0.0f, 0.0f,     0.941, 0.501, 0.219,
        0.1f,  0.0f, 0.0f,    0.941, 0.501, 0.219,
        0.1f,  -0.2f, 0.0f,    0.941, 0.501, 0.219,
        ...
        //helice izq
         -0.1f, 0.0f, 0.0f,    0.525, 0.941, 0.219,
        -0.1f,  -0.2f, 0.0f,    0.525, 0.941, 0.219,
        -0.3f,  -0.2f, 0.0f,   0.525, 0.941, 0.219,

         -0.3f, -0.2f, 0.0f,    0.933, 0.447, 0.588,
        -0.1f,  -0.2f, 0.0f,    0.933, 0.447, 0.588,
        -0.1f,  -0.4f, 0.0f,    0.933, 0.447, 0.588,
        


        //helica derecha

        0.1f, 0.0f, 0.0f,    0.219, 0.941, 0.733,
        0.1f,  -0.2f, 0.0f,    0.219, 0.941, 0.733,
        0.3f,  -0.2f, 0.0f,    0.219, 0.941, 0.733,

         0.3f, -0.2f, 0.0f,    0.219, 0.941, 0.733,
        0.1f,  -0.2f, 0.0f,    0.219, 0.941, 0.733,
        0.3f,  -0.4f, 0.0f,    0.219, 0.941, 0.733,
        

        // Cabina de astronautas+

         -0.2f, 0.0f, 0.0f,    0.941, 0.749, 0.219,
        -0.2f,  0.4f, 0.0f,    0.941, 0.749, 0.219,
        0.2f,  0.4f, 0.0f,    0.941, 0.749, 0.219,

        -0.2f, 0.0f, 0.0f,    0.219, 0.611, 0.941,
        0.2f,  0.0f, 0.0f,    0.219, 0.611, 0.941,
        0.2f,  0.4f, 0.0f,    0.219, 0.611, 0.941,
        
        //Techo
        -0.2f, 0.4f, 0.0f,    0.839, 0.160, 0.172,
        0.2f,  0.4f, 0.0f,    0.839, 0.160, 0.172,
        0.0f,  0.6f, 0.0f,    0.839, 0.160, 0.172,
